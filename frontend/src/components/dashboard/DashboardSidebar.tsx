...
export function DashboardSidebar() {
  ...
  const menuItems = [
    { title: "Dashboard", path: "/dashboard", icon: Home, count: 0 },
    { title: "Resume Builder", path: "/dashboard/builder", icon: FileText, count: 0 },
    { title: "Resume Analysis", path: "/dashboard/analyze", icon: Upload, count: 0 },
  { title: "Find Job", path: "/dashboard/find-job", icon: BarChart, count: 0 },
    { title: "Cover Letters", path: "/dashboard/cover-letter", icon: FileEdit, count: 0, isNew: true },
    { title: "My Documents", path: "/dashboard/my-resumes", icon: List, count: 0 },
    { title: "Help & Tips", path: "/dashboard/help", icon: HelpCircle, count: 0 },
  ];
  ...
  <Link to="/dashboard" className="flex items-center p-2">
          ...
          <span className="text-lg sm:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">ResumeXpert</span>
        </Link>
      </SidebarHeader>
