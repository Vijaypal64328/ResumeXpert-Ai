import { BellIcon, User, Settings, LogOut, HelpCircle } from "lucide-react";
...
export function TopNav() {
  ...
  {/* Search removed to simplify navbar per project preference */}
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-3">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-48 sm:w-56" align="end" forceMount>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="flex items-center cursor-pointer text-sm" onClick={() => navigate('/dashboard/profile')}>
              <User className="mr-2 h-4 w-4 text-gray-500" />
              <span>My Profile</span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex items-center cursor-pointer text-sm" onClick={() => navigate('/dashboard/settings')}>
