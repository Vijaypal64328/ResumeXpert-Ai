        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-center sm:text-left">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="mb-4 sm:mb-6">
              <span className="font-bold text-xl sm:text-2xl text-slate-900">ResumeXpert</span>
            </div>
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              ...
              <a 
                href="https://www.linkedin.com/in/vijaypal-singh-5b616125a/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                aria-label="LinkedIn - Vijaypal Singh"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
              </a>
              <a 
                href="https://github.com/Vijaypal64328" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                aria-label="GitHub - Vijaypal64328"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <span
                  className="text-sm sm:text-base text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center group cursor-pointer"
                  onClick={() => {
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              {/* Removed support@ email link for simplicity */}
            </ul>
          </div>
        </div>
        
        <div className="border-t border-slate-100 mt-10 sm:mt-16 pt-6 sm:pt-8 w-full flex flex-col items-center text-slate-500 text-xs sm:text-sm gap-2">
          <span>&copy; {currentYear} ResumeXpert. All rights reserved.</span>
          <span>Developed by Vijaypal</span>
        </div>
      </div>
