            ...
            <div className="min-h-screen flex">
                <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
                    <div className="w-full max-w-md space-y-6">
                        <h1 className="text-3xl md:text-4xl font-bold text-theme-darkSlate">Join ResumeXpert pro</h1>
                        ...
                        <form onSubmit={handleSignup} className="space-y-4 pt-4">
                            ...
                            <div className="flex justify-center mt-4">
                                ...
                                <Link to="/login" className="font-semibold text-theme-blue hover:underline text-sm ml-1">
                                    Log In
                                </Link>
                            </div>
                        </form>
